...
public class UserResource {
	...
	public ResponseEntity<User> insert(@RequestBody  User obj)
	{
		...
		URI uri_new_user = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(obj.getId()).toUri();
		return ResponseEntity.created(uri_new_user).body(obj);
	}
